# Generated by Powerlevel10k configuration wizard on 2021-12-31 at 07:04 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_HOST_ROOT_FOREGROUND=235
  typeset -g POWERLEVEL9K_HOST_ROOT_BACKGROUND=10
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_HOST_{REMOTE,REMOTE_SUDO}_FOREGROUND=235
  typeset -g POWERLEVEL9K_HOST_{REMOTE,REMOTE_SUDO}_BACKGROUND=10
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_HOST_FOREGROUND=235
  typeset -g POWERLEVEL9K_HOST_BACKGROUND=10

  # Context format when running with privileges: hostname
  typeset -g POWERLEVEL9K_HOST_ROOT_TEMPLATE='%m'
  # Context format when in SSH without privileges: hostname
  typeset -g POWERLEVEL9K_HOST_{REMOTE,REMOTE_SUDO}_TEMPLATE='%m'
  ...
  typeset -g POWERLEVEL9K_USER_ROOT_BACKGROUND=238
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_USER_{REMOTE,REMOTE_SUDO}_FOREGROUND=15
  typeset -g POWERLEVEL9K_USER_{REMOTE,REMOTE_SUDO}_BACKGROUND=238
  # Default context color (no privileges, no SSH).
  typeset -g POWERLEVEL9K_USER_FOREGROUND=15
  typeset -g POWERLEVEL9K_USER_BACKGROUND=238

  # Context format when running with privileges: user.
  typeset -g POWERLEVEL9K_USER_ROOT_TEMPLATE='%n'
  # Context format when in SSH without privileges: user.
  typeset -g POWERLEVEL9K_USER_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n'
